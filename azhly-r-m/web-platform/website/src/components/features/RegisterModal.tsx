...
const response = await register({
    ...
    universityName: form.instituteName,

    campusName: form.campusName,

    instituteType: form.institutionType,
  ...
  type="submit"
  disabled={loading}
  className="w-full bg-gradient-to-r from-brand-purple to-brand-pink text-white font-bold py-4 rounded-xl text-sm tracking-wide transition-opacity hover:opacity-90 shadow-lg flex items-center justify-center gap-2 disabled:opacity-60"
>
